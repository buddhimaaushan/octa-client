...
const Navbar = (props: Props) => {
  ...
  return (
    <div className="dark:bg-primaryLight/80 bg-white/70 drop-shadow-xl/80 w-full h-20 py-3 px-2 dark:border border-gray-700 rounded-lg flex justify-center sm:justify-between items-center">
      ...
      <div className="w-full sm:w-max flex justify-between items-center">
        <div className="mx-3 h-full flex justify-center items-center">
        ...
        <div className=" dark:bg-primaryDark/70 bg-blue-200 px-3 py-3 rounded-lg  h-full flex justify-center items-center">
